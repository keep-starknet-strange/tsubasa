  ...
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="relative z-20" onClose={() => {}}>
        ...
        <div className="fixed inset-0 z-10 flex items-center justify-center overflow-y-auto text-black">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="h-full w-full transform overflow-auto bg-white text-left shadow-xl transition-all sm:my-8 sm:p-6">
