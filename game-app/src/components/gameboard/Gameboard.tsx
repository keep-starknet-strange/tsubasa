    ...
    <div className="h-screen max-h-96 w-full lg:m-auto lg:h-[645px] lg:max-h-[645px] lg:w-11/12 lg:max-w-[1296px]">
      ...
      <div className="relative mx-auto box-border flex h-full max-h-[645px] w-11/12 overflow-hidden rounded-xl border-[3px] border-solid border-[#97E8A9] bg-[#8ADD9D] lg:h-full lg:w-full ">
        ...
        <div className="absolute bottom-0 left-2/4 -translate-x-2/4 lg:bottom-auto lg:left-0 lg:top-2/4 lg:-translate-x-0 lg:-translate-y-2/4">
          {/* goal boxes */}
          <div className="relative z-20 h-12 w-32 rounded-t-xl border-[3px]  border-b-0  border-solid border-[#97E8A9]	 bg-[#8ADD9D] lg:h-96 lg:w-24 lg:rounded-l-none lg:rounded-r-xl lg:border-b-[3px] lg:border-l-0" />
          {/* goal circle */}
        ...
        {/* defender position */}
        <div className="absolute left-8 top-12 z-30 lg:bottom-1/4 lg:left-[12.5%] lg:top-auto">
          <CardPlaceholder
            currentHoveredPlaceholder={currentHoveredPlaceholder}
            id="defender-1"
            position="defender"
        ...
        {/* midfielder position */}
        <div className="absolute bottom-20 right-8 z-30 lg:bottom-auto lg:left-[22%] lg:right-auto lg:top-1/4">
          <CardPlaceholder
            currentHoveredPlaceholder={currentHoveredPlaceholder}
            id="midfielder-1"
            position="midfielder"
        ...
        {/* center line */}
        <div className="absolute left-0 right-0 top-2/4  border-[3px] border-solid border-[#97E8A9] lg:bottom-0 lg:left-2/4 lg:top-0" />
        ...
        <div className="absolute left-2/4 top-2/4 -translate-x-2/4 -translate-y-2/4 ">
          ...
          {/* defender position */}
          <div className="absolute bottom-12 left-8 z-30 lg:bottom-1/4 lg:left-auto lg:right-[12.5%] ">
            <PlayerPlaceholder
              currentHoveredPlaceholder={currentHoveredPlaceholder}
              id="defender-2"
              position="defender"
