...
use tsubasa::systems::{
    ...
    IEndTurnDispatcher, IEndTurnDispatcherTrait, IPlaceCardDispatcher, IPlaceCardDispatcherTrait, create_card_system, place_card_system, end_turn_system, attack_system
};
...
fn test_attack_player1_scores_against_empty_board() {
    ...
    create_card_system_1.create_card(world, 0, 22, 17, 0, Roles::Attacker, true);
    // Player 1 plays
...
fn test_attack_player1_defender_passes_enemy_midfielder() {
    ...
    // Card for player 1
    // Token_id, Dribble, Defense, Cost, Role, is captain
    create_card_system_1.create_card(world, 0, 45, 5, 1, Roles::Defender, false);

    // Card for player 2
    create_card_system_1.create_card(world, 1, 1, 2, 0, Roles::Midfielder, false);
    ...
    // Player 2 plays
    set_contract_address(player2);
    place_card_system_1.place_card(world, game_id, 0, Roles::Midfielder);
    end_turn_system_1.end_turn(world, game_id);
    assert(count_cards_in_hand(world, player2) == 1, 'Wrong nb of cards drawn player2');
    assert(count_cards_in_hand(world, player1) == 1, 'Wrong nb of cards drawn player1');
...
fn test_attack_player1_goalkeeper_gets_passed_enemy_defender() {
    ...
    // Card for player 2
    create_card_system_1.create_card(world, 1, 5,45,1, Roles::Goalkeeper, false);
    ...
    assert(player2_board.defender_placement == Placement::Side, 'Defender 2 shouldnt be empty');
    assert(
